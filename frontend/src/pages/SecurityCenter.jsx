    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '24px', flexWrap: 'wrap' }}>
        {[
          ...
          (user?.role === 'Super Admin' || user?.role === 'Admin Controller') && { key: 'licensing', name: 'Licensing & Sharing', icon: ShieldAlert },
            ...
            {activeTab === 'licensing' && (
              <div>
                <h3 style={{ fontSize: '18px', borderBottom: '1px solid var(--border-color)', paddingBottom: '12px', marginBottom: '20px', color: 'var(--chub-purple)' }}>
                  Portal Licensing & Shared Modules
                </h3>

                {/* Case A: Super Admin view */}
                  ...
                  <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
                    ...
                    <div className="card" style={{ flex: 1.2, minWidth: '280px' }}>
                      ...
                      <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginBottom: '16px' }}>
                        Admin Controller Limit: <strong style={{ color: 'var(--chub-pink)' }}>{subAdminsList.length} / {licensingData.admin_creation_limit}</strong> sub-admins created.
                      </p>
                        ...
                        <form onSubmit={handleSaveSubAdminAccess}>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '24px' }}>
                            {licensingData.modules
                              .filter(m => m.is_enabled) // Admin Controller can only share modules enabled by Super Admin
                              .map((m) => {
